...
# Define the directory and requirements path for finetuning
...
def run_finetuning_on_sagemaker(
    ...
    # Check if the finetuning directory and requirements file exist
    ...
    # Get the current Hugging Face user information
    api = HfApi()
